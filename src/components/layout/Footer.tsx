...
export const Footer: React.FC<FooterProps> = ({
  ...
  if (variant === 'minimal') {
    return (
      <footer className={cn(
        'border-t border-gray-200 bg-white py-4',
        className
      )}>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold text-gray-900">TimeTracker</span>
            </div>
            <p className="mt-4 text-sm text-gray-600">
              Simple, elegant time tracking with California labor law compliance.
              Track your work hours with confidence.
            </p>
            <div className="mt-4">
              <span className="text-sm text-gray-500">Starting at $1.99/month</span>
            </div>
          </div>
